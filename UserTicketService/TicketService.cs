...
namespace UserTicketService
{
	public class TicketService : ITicketService
	{
		...
		public Ticket GetTicket(int ticketId)
		{
			...
			// после выполнения теста проводим необходимый рефакторинг кода
			var ticket = FakeBaseData.FirstOrDefault(t => t.Id == ticketId);
			return (ticket is null) ?
		...
		/*
		 * закрыт для тестирования методом PrivateObject
		...
		*/
		...
		/*
		 * удален после рефакторинга для интеграционного тестирования
